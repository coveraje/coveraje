    ...
    var helper = (function () {
        ...
        function requireSubst(parent) {
            return function (m) {
                ...
                var pathToCode;
                pathToCode = Module._resolveFilename(m, parent || module)[1];
                if (pathToCode != null && path.existsSync(pathToCode)) {
                    var code = require("fs").readFileSync(pathToCode, 'utf-8');
