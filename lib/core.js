    ...
    function Coveraje(code, runner, options) {
        ...
        var injector = (function () {
            ...
            var addVisitAndReturnValue = visithelp(function (expr, key, pos, endpos) {
                return callRuntime("visit", "callWithRet", [ [ "num", key ], expr, [ "num", pos ], [ "num", endpos ] ]);
            });
            ...
            var callVisitFunc = visithelp(function (expr, key, pos, endpos) {
                return stat(callRuntime("visit", "call", [ [ "num", key ], [ "num", pos ], [ "num", endpos ] ]));
            });
            ...
            function callVisitFuncParams(func, key, args) {
                ...
                return stat(callRuntime("visit", "funcargs", [ [ "num", key], [ "name", "arguments" ], [ "array", argArr] ]));
            }
            
            var addVisit = visithelp(function (expr, key, pos, endpos) {
                var vc = stat(callRuntime("visit", "call", [ [ "num", key ], [ "num", pos ], [ "num", endpos ] ]));
            ...
            var addBranchSwitch = branchhelp(function (expr, key, keywordPos, keywordEndpos, branchPos, branchEndpos) {
                var bc = callRuntime("branch", "call", [ [ "num", key ], [ "num", keywordPos ], [ "num", keywordEndpos ], [ "num", branchPos ], [ "num", branchEndpos ] ]);
            ...
            var addBranchIf = branchhelp(function (expr, key, keywordPos, keywordEndpos, branchPos, branchEndpos) {
                var ret = stat(callRuntime("branch", "call", [ [ "num", key ], [ "num", keywordPos ], [ "num", keywordEndpos ], [ "num", branchPos ], [ "num", branchEndpos ] ]));
