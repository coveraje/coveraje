...
var coveraje = (function () {
    ...
    var uglifyjs = require("../deps/UglifyJS/uglify-js"),
        CoverajeEvent = require("./CoverajeEvent").CoverajeEvent;
    ...
    function Coveraje(code, runner, options) {
        ...
        return (function () {
            ...
            if (typeof code === "string") {
                ...
                instance.code = code;
                instance.skippedLines = prep.skippedLines;
    ...
    var runHelper = (function () {
        ...
        var itself = function (framework, options) {
            return {
                run: function (file) {
                    return createEmitter(function (event) {
                        require("./helper").run(file, framework, event, options);
                    });
                }
            };
        };
